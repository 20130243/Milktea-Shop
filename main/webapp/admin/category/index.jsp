                                        ...
                                        <c:forEach var="item" items="${requestScope['categoryList']}" varStatus="status">
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-action text-center">
                                                    <a href="/admin/category-update?id=<c:out value="${item.id}"/>" class="action-icon"> <i
                                                            class="mdi mdi-square-edit-outline"></i></a>
                                                    <a href="/admin/category-delete?id=<c:out value="${item.id}"/> " class="action-icon" > <i
                                                            class="mdi mdi-delete delete-btn" data-name="<c:out value="${item.name}"/>"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <nav>
                                        <ul class="pagination pagination-rounded mb-0">
                                            <li class="page-item  <c:if test="${currentPage eq 1 }"> d-none </c:if>">
                                                <a class="page-link" href="/admin/category?page=<c:out value='${i-1}'/>" aria-label="Previous">
                                            ...
                                            <li class="page-item <c:if test="${currentPage eq endPage }"> d-none </c:if>">
                                                <a class="page-link" href="/admin/category?page=<c:out value='${i+1}'/>" aria-label="Next">
