                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="../sale/index.jsp">Giảm giá</a></li>
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="min_price">Số tiền giảm tối đa</label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="order_count">Số đơn hàng đã đặt tối thiểu</label>
                                                    <input type="number" id="order_count" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="order_price_total">Tổng giá trị đơn hàng đã đặt tối
                                                        thiểu</label>
                                                    <input type="number" id="order_price_total" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="min_price_order">Giá trị hóa đơn tối thiểu</label>
                                                    <input type="number" id="min_price_order" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="min_date">Ngày lập tài khoản tối thiểu</label>
